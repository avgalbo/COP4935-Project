...
/*
 *  This activity shows the user a list of contacts that have no flagged content on the initial
 *  pairing. We recommend that the user does adds these contacts to the CoT since there is no
 *  flagged content. Once the user has decided if they want to add anyone to the CoT from
 *  this list, they are brought to the main dashboard
 * */

public class InitialContactTrustedFragment extends Fragment {
    ...
    public InitialContactTrustedFragment(InitialSelectTrust initialSelectTrust) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_cot_initial_trusted, container, false);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(initialSelectTrust, "Submit", Toast.LENGTH_SHORT).show();

                String url = AppStatus.serverURL+"/upload-initial-cot.php";
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        ArrayList<String> numbers = initialSelectTrust.getListNumbers();
                        int i = 0;
                        params.put("auth_token", AppStatus.account.getIdToken());
                        JSONObject jsonObject = new JSONObject();
                        for(String number : numbers){
                            try {
                                jsonObject.put("number_"+i, number);
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            i++;
                        }
                        params.put("numbers", jsonObject.toString());
                        ...
                        try {
                            ...
                            for (String text : texts) {
                                ...
                                if(data.flaggedRecd == 0 && data.flaggedSent == 0){
                                    data.selected = true;
                                    initialSelectTrust.addNumber(data.number);
